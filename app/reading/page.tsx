...
export default function ReadingPage() {
  ...
  const spreadName = spreadConfig?.name ?? session.spreadType;
          ...
          >
            {isCeltic && (
              <>
                ...
                <div className="flex items-center justify-center" style={{ gridColumn: "2 / 4", gridRow: "1 / 2" }}>
                  {drawnCards[4] && (
                    <TarotCard card={drawnCards[4].card} positionName={drawnCards[4].position.label} size="sm" index={4} {...cardProps(4)} />
                  )}
                </div>
                ...
                <div className="flex items-center justify-center" style={{ gridColumn: "1 / 2", gridRow: "2 / 4" }}>
                  {drawnCards[3] && (
                    <TarotCard card={drawnCards[3].card} positionName={drawnCards[3].position.label} size="sm" index={3} {...cardProps(3)} />
                  )}
                </div>
                ...
                <div className="flex items-center justify-center" style={{ gridColumn: "2 / 3", gridRow: "2 / 4" }}>
                  {drawnCards[0] && (
                    <TarotCard card={drawnCards[0].card} positionName={drawnCards[0].position.label} size="sm" index={0} {...cardProps(0)} />
                  )}
                </div>
                ...
                <div className="flex items-center justify-center" style={{ gridColumn: "3 / 4", gridRow: "2 / 4" }}>
                  {drawnCards[1] && (
                    <TarotCard card={drawnCards[1].card} positionName={drawnCards[1].position.label} size="sm" index={1} {...cardProps(1)} />
                  )}
                </div>
                ...
                <div className="flex items-center justify-center" style={{ gridColumn: "4 / 5", gridRow: "2 / 4" }}>
                  {drawnCards[5] && (
                    <TarotCard card={drawnCards[5].card} positionName={drawnCards[5].position.label} size="sm" index={5} {...cardProps(5)} />
                  )}
                </div>
                ...
                <div className="flex items-center justify-center" style={{ gridColumn: "2 / 4", gridRow: "4 / 5" }}>
                  {drawnCards[2] && (
                    <TarotCard card={drawnCards[2].card} positionName={drawnCards[2].position.label} size="sm" index={2} {...cardProps(2)} />
                  )}
                </div>
                  ...
                  >
                    {drawnCards[posIdx] && (
                      <TarotCard
                        ...
                        positionName={drawnCards[posIdx].position.label}
                        labelSide="right"
                        size="sm"
                        index={posIdx}
                        {...cardProps(posIdx)}
            ...
            {session.spreadType === "pentagram" && (
              <>
                <div className="col-start-2 row-start-1 flex items-center justify-center">
                  {drawnCards[0] && <TarotCard card={drawnCards[0].card} positionName={drawnCards[0].position.label} size="md" index={0} {...cardProps(0)} />}
                </div>
                <div className="col-start-3 row-start-2 flex items-center justify-center">
                  {drawnCards[1] && <TarotCard card={drawnCards[1].card} positionName={drawnCards[1].position.label} size="md" index={1} {...cardProps(1)} />}
                </div>
                <div className="col-start-3 row-start-3 flex items-center justify-center">
                  {drawnCards[2] && <TarotCard card={drawnCards[2].card} positionName={drawnCards[2].position.label} size="md" index={2} {...cardProps(2)} />}
                </div>
                <div className="col-start-1 row-start-3 flex items-center justify-center">
                  {drawnCards[3] && <TarotCard card={drawnCards[3].card} positionName={drawnCards[3].position.label} size="md" index={3} {...cardProps(3)} />}
                </div>
                <div className="col-start-1 row-start-2 flex items-center justify-center">
                  {drawnCards[4] && <TarotCard card={drawnCards[4].card} positionName={drawnCards[4].position.label} size="md" index={4} {...cardProps(4)} />}
                </div>
              </>
            )}
            ...
            {session.spreadType === "three-card" && drawnCards.slice(0, 3).map((dc, i) => (
              <TarotCard
                key={i}
                card={dc.card}
                positionName={dc.position.label}
                size="lg"
                index={i}
                {...cardProps(i)}
              />
          ...
          >
            ...
            <p className="text-sm text-primary uppercase tracking-[0.2em] font-cinzel">
              {isComplete
                ? "Reading Complete"
                : revealedCount === 0
                ? `${cardCount} cards • click the glowing card`
                : `${revealedCount} of ${cardCount} revealed`}
            </p>
          </motion.div>
        </div>
