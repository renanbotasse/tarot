...
"[project]/components/mobile/MobileReadingPage.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MobileReadingPage() {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(63);
    if ($[0] !== "26f81b636e3aab729ebd3661287f89594b7fd6106c507e855a7d63f95201e2d2") {
        for(let $i = 0; $i < 63; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "26f81b636e3aab729ebd3661287f89594b7fd6106c507e855a7d63f95201e2d2";
    }
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const session = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useSessionStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSessionStore"])(_MobileReadingPageUseSessionStore);
    const revealNextCard = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useSessionStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSessionStore"])(_MobileReadingPageUseSessionStore2);
    const t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useT$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useT"])();
    const { lang } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useLanguageStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguageStore"])();
    ...
    let t0;
    if ($[1] !== session.spreadType) {
        t0 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$spreads$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSpread"])(session.spreadType);
        $[1] = session.spreadType;
        $[2] = t0;
    } else {
        t0 = $[2];
    }
    const spreadConfig = t0;
    const spreadName = lang === "pt" ? spreadConfig?.namePt ?? spreadConfig?.name ?? session.spreadType : spreadConfig?.name ?? session.spreadType;
    let t1;
    if ($[3] !== lang) {
        t1 = ({
            "MobileReadingPage[posLabel]": (pos)=>lang === "pt" ? pos.labelPt ?? pos.label : pos.label
        })["MobileReadingPage[posLabel]"];
        $[3] = lang;
        $[4] = t1;
    } else {
        t1 = $[4];
    ...
    if ($[5] !== lang) {
        t2 = ({
            "MobileReadingPage[posDesc]": (pos_0)=>lang === "pt" ? pos_0.descriptionPt ?? pos_0.description : pos_0.description
        })["MobileReadingPage[posDesc]"];
        $[5] = lang;
        $[6] = t2;
    } else {
        t2 = $[6];
    ...
    let t3;
    if ($[7] !== isComplete || $[8] !== revealNextCard || $[9] !== revealedCount) {
        t3 = ({
            "MobileReadingPage[handleCardTap]": (index)=>{
                if (index < revealedCount) {
                    setActivePosition(index);
                } else {
                    if (index === revealedCount && !isComplete) {
                        revealNextCard();
                        setActivePosition(index);
                    }
                }
            }
        })["MobileReadingPage[handleCardTap]"];
        $[7] = isComplete;
        $[8] = revealNextCard;
        $[9] = revealedCount;
        $[10] = t3;
    ...
    const handleCardTap = t3;
    let t4;
    if ($[11] !== isComplete || $[12] !== router) {
        t4 = ({
            "MobileReadingPage[handleRevealNext]": ()=>{
                if (isComplete) {
                    router.push("/");
                    return;
                }
    ...
    const handleRevealNext = t4;
    let t5;
    if ($[14] !== activePosition || $[15] !== handleCardTap || $[16] !== isComplete || $[17] !== revealedCount) {
        t5 = ({
            "MobileReadingPage[cardProps]": (index_0)=>({
                    ...
                    onClick: ()=>handleCardTap(index_0)
                })
        })["MobileReadingPage[cardProps]"];
        $[14] = activePosition;
        $[15] = handleCardTap;
        $[16] = isComplete;
        $[17] = revealedCount;
    ...
    let t12;
    if ($[29] !== cardCount || $[30] !== isComplete || $[31] !== revealedCount || $[32] !== t.reading) {
        t12 = isComplete ? t.reading.readingComplete : revealedCount === 0 ? t.reading.clickToBegin : t.reading.revealedOf(revealedCount, cardCount);
        $[29] = cardCount;
        $[30] = isComplete;
        $[31] = revealedCount;
        $[32] = t.reading;
    ...
    let t14;
    if ($[36] !== cardProps || $[37] !== drawnCards || $[38] !== posLabel || $[39] !== session.spreadType) {
        t14 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "flex-1 overflow-y-auto pt-2 pb-8",
            children: session.spreadType === "three-card" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex gap-4 justify-center px-4 py-4",
                children: drawnCards.slice(0, 3).map({
                    "MobileReadingPage[(anonymous)()]": (dc, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: drawnCards.map({
                    "MobileReadingPage[drawnCards.map()]": (dc_0, i_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$reading$2f$TarotCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    card: dc_0.card,
                                    positionName: posLabel(dc_0.position),
                                    size: "sm",
                                    index: i_0,
                                    ...cardProps(i_0)
                                }, void 0, false, {
                ...
                }["MobileReadingPage[drawnCards.map()]"])
            }, void 0, false, {
                fileName: "[project]/components/mobile/MobileReadingPage.tsx",
                lineNumber: 218,
                columnNumber: 57
        ...
        $[37] = drawnCards;
        $[38] = posLabel;
        $[39] = session.spreadType;
        $[40] = t14;
    } else {
        t14 = $[40];
    }
    let t15;
    if ($[41] !== activeCard || $[42] !== activePos || $[43] !== activePosition || $[44] !== cardCount || $[45] !== cardKeywords || $[46] !== cardMeaning || $[47] !== cardName || $[48] !== handleRevealNext || $[49] !== isComplete || $[50] !== posDesc || $[51] !== posLabel || $[52] !== t.card || $[53] !== t.reading.backHome || $[54] !== t.reading.revealNext) {
        t15 = activeCard && activePos && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                    ...
                    onClick: {
                        "MobileReadingPage[<motion.div>.onClick]": ()=>setActivePosition(null)
                    }["MobileReadingPage[<motion.div>.onClick]"]
                }, void 0, false, {
                    fileName: "[project]/components/mobile/MobileReadingPage.tsx",
                    lineNumber: 233,
                    columnNumber: 40
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: (cardKeywords ?? activeCard.keywords).slice(0, 3).map(_MobileReadingPageAnonymous)
                                                }, void 0, false, {
                                                    fileName: "[project]/components/mobile/MobileReadingPage.tsx",
                                                    lineNumber: 274,
                                                    columnNumber: 41
        ...
        $[51] = posLabel;
        $[52] = t.card;
        $[53] = t.reading.backHome;
        $[54] = t.reading.revealNext;
        $[55] = t15;
    } else {
        t15 = $[55];
    }
    ...
    let t17;
    if ($[58] !== t11 || $[59] !== t13 || $[60] !== t14 || $[61] !== t16) {
...
_s(MobileReadingPage, "l+shfaYRlqZASZmgrMMS9AQF/mo=", false, function() {
    return [
...
_c = MobileReadingPage;
function _MobileReadingPageAnonymous(kw) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
function _MobileReadingPageUseSessionStore2(s_0) {
    return s_0.revealNextCard;
}
function _MobileReadingPageUseSessionStore(s) {
    return s.session;
}
var _c;
__turbopack_context__.k.register(_c, "MobileReadingPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$mobile$2f$MobileReadingPage$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/mobile/MobileReadingPage.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useSessionStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/store/useSessionStore.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$spreads$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/spreads.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useT$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useT.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useLanguageStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/store/useLanguageStore.ts [app-client] (ecmascript)");
...
function ReadingPage() {
    ...
    if ($[0] !== "a935daebcf9ae8e48586ae1008cc84c464983099160f2b777de107d25aac394e") {
        for(let $i = 0; $i < 132; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "a935daebcf9ae8e48586ae1008cc84c464983099160f2b777de107d25aac394e";
    }
    ...
    if (isMobile) {
        ...
        if ($[16] === Symbol.for("react.memo_cache_sentinel")) {
            t6 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$mobile$2f$MobileReadingPage$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                fileName: "[project]/app/reading/page.tsx",
                lineNumber: 152,
                columnNumber: 12
            }, this);
    ...
    let t8;
    if ($[21] !== isCeltic || $[22] !== session.spreadType) {
        t8 = ({
    ...
    let t9;
    if ($[24] !== activePosition || $[25] !== handleCardClick || $[26] !== isComplete || $[27] !== revealedCount) {
        t9 = ({
    ...
    let t41;
    if ($[79] !== cardProps || $[80] !== drawnCards || $[81] !== isCeltic || $[82] !== posLabel) {
    ...
    let t42;
    if ($[84] !== cardProps || $[85] !== drawnCards || $[86] !== posLabel || $[87] !== session.spreadType) {
        ...
        $[85] = drawnCards;
        $[86] = posLabel;
        $[87] = session.spreadType;
        $[88] = t42;
    } else {
        t42 = $[88];
    }
    let t43;
    if ($[89] !== cardProps || $[90] !== drawnCards || $[91] !== posLabel || $[92] !== session.spreadType) {
        ...
        $[90] = drawnCards;
        $[91] = posLabel;
        $[92] = session.spreadType;
        $[93] = t43;
    } else {
        t43 = $[93];
    }
    let t44;
    if ($[94] !== t39 || $[95] !== t40 || $[96] !== t41 || $[97] !== t42 || $[98] !== t43) {
    ...
    let t49;
    if ($[105] !== cardCount || $[106] !== isComplete || $[107] !== revealedCount || $[108] !== t.reading) {
    ...
    let t55;
    if ($[118] !== activePos || $[119] !== cardCount || $[120] !== handleRevealNext || $[121] !== isComplete || $[122] !== session.spreadType || $[123] !== t53 || $[124] !== t54) {
        ...
        $[118] = activePos;
        $[119] = cardCount;
        $[120] = handleRevealNext;
        $[121] = isComplete;
        $[122] = session.spreadType;
        $[123] = t53;
        $[124] = t54;
        $[125] = t55;
    } else {
...
_s(ReadingPage, "KrUmMumFuW05XGetOq4Rap+A7Eo=", false, function() {
    return [
...
//# sourceMappingURL=_b16fe911._.js.map